# Recursive Symbolics Collective Field Methodology Division Safety Protocols
...
- [ ] Team members should be trained in basic First Aid procedures.
- [ ] Do not attempt to use advanced First Aid techniques without first obtaining and submitting proof of certification to your Principal Operator.
...
- [ ] Use encrypted storage devices for sensitive raw practitioner data.
- [ ] Follow the Data Backup and Storage protocol for secure and organized data storage, which is, with each report submit all gathered data so that it can be stored securely and anonymized to be released to the public.
...
- [ ] Immediately contact your Principal Operator, unless the situation calls for Medical, Fire, or Police Emergency Response, in which case call 9-11, 999, or whatever your emergency number is in the country you're researching in.
